	 ...
	 if($count==0){
	  ...
	  if($conn->query($query))
	  {
	   $msg = "<div class='alert alert-success'>
		  ...
		  <a href='http://107.170.48.163/Mwsu-Web-Dev-Azher/Program_2/login.php'> Clicked here to go to Login Page </a>
		  </div>		 
		 ";
	  }
	  else
...
<div class="row">
  ...
  ?>
			...
			<hr class="colorgraph">
			<div class="row">
				<div class="col-xs-12 col-md-6"><input type="submit" value="Register" name="register" class="btn btn-primary btn-block btn-lg" tabindex="7" id="btnRegister"></div>
